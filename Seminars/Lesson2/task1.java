...
public class task1 {
    ...
    static void WriteAnswerToFile(String data, String path) {
        ...
        try {
            FileHandler fileHandler = new FileHandler("Seminars/Lesson2/log.txt");
